  ...
  const predictKNN = useCallback(async () => {
    ...
    try {
      ...
      const KNNContract = getContract({
        abi: deployedContracts[1849857664505656].KNN.abi as Abi,
        address: deployedContracts[1849857664505656].KNN.address,
        client: { public: publicClient as PublicClient },
      });
  ...
  const predictLinearRegression = useCallback(async () => {
    ...
    try {
      ...
      const LinearRegressionContract = getContract({
        abi: deployedContracts[1849857664505656].LinearRegression.abi as Abi,
        address: deployedContracts[1849857664505656].LinearRegression.address,
        client: { public: publicClient as PublicClient },
      });
  ...
  const predictAnomalyDetection = useCallback(async () => {
    ...
    try {
      const AnomalyDetectionContract = getContract({
        abi: deployedContracts[1849857664505656].AnomalyDetection.abi as Abi,
        address: deployedContracts[1849857664505656].AnomalyDetection.address,
        client: { public: publicClient as PublicClient },
      });
